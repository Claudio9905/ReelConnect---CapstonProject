      ...
      <Container className=" d-sm-flex d-md-none d-lg-none flex-column container-footer">
        <Row className="d-flex justify-content-between g-2">
          <Col xs={12} className=" text-center">
            <a
              href="https://www.instagram.com/claudio_postiglione99/#"
          ...
          <Col xs={12} className=" text-center col-footer3">
            ...
            >
              ...
              cloudpost10@gmail.com
            </a>
          </Col>
        </Row>
      </Container>
      {/* Versione tablet/desktop */}
      <Container className=" d-none d-md-flex flex-column container-footer">
        <Row className="d-flex justify-content-between">
          <Col xs={12} md={4} className=" text-center col-footer1-md">
            <a
              href="https://www.instagram.com/claudio_postiglione99/#"
              className=" text-decoration-none text-light"
            >
          ...
          <Col xs={12} md={4} className=" text-center col-footer2-md">
            <h3 className="fs-5"> ReelConnect - 2025</h3>
          </Col>
