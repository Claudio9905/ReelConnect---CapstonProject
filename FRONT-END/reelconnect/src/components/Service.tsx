        ...
        <Container className="d-none d-lg-flex flex-column">
          ...
          <Row id="row-serviceFilm" className="p-5 d-flex  ">
            {/* {Array.isArray(movies) &&
              movies.map((film) => {
                return ( */}
            <Col xs={12} md={6} lg={4} className="col1-film-lg">
              <Card className="card-film-serieTv-lg">
                <Card.Img
                  variant="top"
                  src={bannerFilm}
                  className="img-fluid cover-image"
                ...
                <Card.Body className="d-flex flex-column align-items-center justify-content-center body-card-catalogo ">
                  ...
                  <Card.Text className="d-flex ">Anno di uscita</Card.Text>
                  <div className="d-flex justify-content-between gap-3">
                    <Button className="button-with-icon w-50" type="submit">
                      <svg
                        className="icon"
                        id="Play"
                        viewBox="0 0 48 48"
          ...
          <Row id="row-serviceSerieTv" className="p-5 d-flex ">
            {/* {Array.isArray(seriesTV) &&
              seriesTV.map((seriesTV) => {
                return ( */}
            <Col xs={12} md={6} lg={4} className="col2-serieTv-lg">
              <Card className="card-film-serieTv-lg">
                <Card.Img
                  variant="top"
                  src={bannerFilm}
